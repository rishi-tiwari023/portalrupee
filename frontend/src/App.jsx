...
const Home = () => (
  <div className="flex flex-col gap-12 w-full max-w-7xl mx-auto p-6 md:p-12">
    <div className="text-center py-10 flex flex-col items-center">
      <div className="w-24 h-24 mb-6 rounded-3xl overflow-hidden shadow-xl shadow-indigo-100/50">
  ...
  <div className="w-full">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
      <div className="premium-card p-6 border-l-4 border-l-indigo-500">
        ...
        <p className="text-4xl font-bold bg-gradient-to-br from-indigo-700 to-indigo-400 bg-clip-text text-transparent">₹4,500</p>
      </div>
