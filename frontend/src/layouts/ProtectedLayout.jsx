  ...
  return (
    <div className="flex h-screen w-full bg-[#fcfdfe] overflow-hidden font-sans selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <main className="flex-1 flex flex-col h-full overflow-y-auto relative no-scrollbar">
        ...
        {/* Top Header */}
        <header className="w-full h-32 bg-white/60 backdrop-blur-xl sticky top-0 z-20 flex items-center justify-between px-10 border-b border-white/40">
          <div className="flex items-center gap-4 bg-slate-100/50 px-4 py-2 mx-10 my-4 rounded-2xl border border-white/50 w-full max-w-md group focus-within:bg-white focus-within:shadow-lg focus-within:shadow-indigo-500/5 transition-all duration-300">
        ...
        {/* Main Content Area */}
        <div className="flex-1 p-10 pt-8 max-w-[1600px] mx-auto w-full">
          <Outlet />
        </div>
      </main>
    </div>
